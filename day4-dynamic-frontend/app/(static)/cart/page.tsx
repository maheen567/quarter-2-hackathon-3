            ...
            <div className="flex flex-col md:flex-row justify-between px-4 lg:px-[7%] pt-28 bg-white gap-6">
              <div className="w-full md:w-[648px]">
                ...
                <div className="border border-solid border-gray-300 rounded-lg p-4 md:p-6 w-full">
                  ...
                  <div className="flex flex-col sm:flex-row items-center sm:-space-x-1">
                    ...
                    />
                    <button className="bg-csYellow hover:bg-orange-500 text-white text-base py-[16px] px-6 md:py-3 rounded-r-md rounded-l-none rounded-br-md rounded-bl-none transition-all duration-200 w-full sm:w-auto cursor-pointer">
                      Apply
                    </button>
                  </div>
                </div>
              ...
              <div className="w-full md:w-[648px]">
                ...
                <div className="w-full flex justify-center">
                  <Link href={"/checkout"}>
                    <button className="inline-flex items-center gap-2 bg-csYellow hover:bg-orange-500 text-white text-[18px] py-2 md:py-[14px] px-6 md:px-8 transition-all duration-300 w-full md:w-auto mt-4 cursor-pointer">
                      Proceed to Checkout
